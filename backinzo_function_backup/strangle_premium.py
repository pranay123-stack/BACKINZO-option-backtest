...
def straddle_backtest(csv_file_path, start_time,squareoff_time, legs):
    ...
    for leg in legs:
        ...
        if not exit_row.empty:
            ...
            exit_time = exit_row['Time'].iloc[0]
        else:
            ticker_row_exit = ticker_row_at_time(df, symbol_to_search, squareoff_time)
...
legs = [
    {'Symbol':'BANKNIFTY06MAR24','type': 'CE','EntryType':"Sell",'ExitType':"Buy" ,'lot_size': 15,'offset':600 },   
    {'Symbol':'BANKNIFTY06MAR24','type': 'PE','EntryType':"Sell",'ExitType':"Buy", 'lot_size': 15 ,'offset':-500},  
