...
def leg_squareoff_using_premeium(csv_file_path,underlying_symbol, entry_time, squareoff_time, legs):
    df = pd.read_csv(csv_file_path)
...
result = leg_squareoff_using_premeium(backtest_config['entry_csv_file_path'],backtest_config['Underlying_Symbol'],backtest_config['entry_time'],backtest_config['squareoff_time'], backtest_config['entrylegs_details'])
print(result)
