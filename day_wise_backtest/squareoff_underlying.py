...
def exit_check(df, entry_order_details,squareoff_time,leg):
    global atm_new
...
def squareoff_underlying(csv_file_path,underlying_symbol, entry_time, squareoff_time, legs):
    df = pd.read_csv(csv_file_path)
    ...
    while pending_legs:
        ...
        for pending_leg in current_pending_legs:
            ...
            exit_row = exit_check(df, entry_order_details, squareoff_time,leg)
...
result =squareoff_underlying(backtest_config['entry_csv_file_path'],backtest_config['Underlying_Symbol'],backtest_config['entry_time'],backtest_config['squareoff_time'], backtest_config['entrylegs_details'])
print(result)
